...
export const ArrowRightLong: FC<Props> = ({
  width,
  height,
  stroke,
  color,
...
export const BrokenHeart: FC<Props> = ({
  width,
  height,
  stroke,
  color,
...
export const Checkmark: FC<Props> = ({ width, height, stroke, color }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Ex: FC<Props> = ({ width, height, stroke, color }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Film: FC<Props> = ({ width, height, stroke, color, fill }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Play: FC<Props> = ({ width, height, stroke, color, fill }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
